  ...
  look: z
    .object({
      ...
      whiteBalanceKelvin: z
        ...
        .catch(null),
      wbShiftRed: safeNumber('WBシフト 赤-シアン方向。-9〜+9。通常は0。', 0, { min: -9, max: 9 }),
      wbShiftBlue: safeNumber('WBシフト 青-黄方向。-9〜+9。通常は0。', 0, { min: -9, max: 9 }),
      ...
      highlightTone: safeNumber(
        'ハイライトトーン -2〜+4（0.5刻み）。白飛びを避けたいならマイナス。',
        0,
        { min: -2, max: 4 },
      ),
      shadowTone: safeNumber(
        'シャドウトーン -2〜+4（0.5刻み）。黒を締めたいならプラス、暗部を起こしたいならマイナス。',
        0,
        { min: -2, max: 4 },
      ),
